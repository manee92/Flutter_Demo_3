...
class _HomeState extends State<Home> {
  ...
  void addInitialData(){
    if(allPlaces.isEmpty){
      allPlaces.put('place01', Place(name: 'Pyramid', image: 'assets/places/img001.jpg'));
      allPlaces.put('place02', Place(name: 'Mirabell Palace and Garden', image: 'assets/places/img002.jpg'));
    }
  }
...
class AttractionCard extends StatelessWidget {
  const AttractionCard(
      {Key? key, required this.image, required this.name, required this.icon, this.onIconTap})
      : super(key: key);
  final String image;
  final String name;
  final IconData icon;
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Image.asset(image, height: 180, width: width,fit: BoxFit.cover,),
            const SizedBox(
              height: 6,
            ),
            Row(
